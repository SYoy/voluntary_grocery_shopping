...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(max_length=254, required=True, help_text='Bitte eine gültige Email-Adresse eingeben. Ihr Name und ihre Email wird nicht veröffentlicht.', label="Email-Adresse")
